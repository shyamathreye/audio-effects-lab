...
export function Chain() {
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      {/* chain rail */}
      <div className="flex items-stretch gap-3 overflow-x-auto rounded-panel bg-outline/40 p-3 ring-1 ring-outline">
        {/* dry / source tap */}
        <div className="flex w-40 shrink-0 flex-col rounded-panel bg-chassis ring-2 ring-grid">
          ...
          <div className="mx-3 mt-3 h-14 overflow-hidden rounded-control ring-1 ring-outline">
            <Waveform getAnalyser={() => engine.getAnalyser('dry')} colorVar="--stage-dry-on-black" className="h-full w-full" />
          </div>
        ...
        {chain.length === 0 && (
          <div className="flex flex-1 items-center justify-center px-8 py-10 text-center font-mono text-sm text-cream/40">
            Empty chain — the dry signal passes straight through.
            <br />
            Add an effect above to start shaping it.
          </div>
        )}
      </div>
    </section>
